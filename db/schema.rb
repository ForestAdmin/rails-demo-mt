...
ActiveRecord::Schema[8.1].define(version: 2026_03_19_000001) do
  ...
  create_table "public.operators", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.unique_constraint ["email"], name: "operators_email_key"
  end
  ...
  create_table "public.payment_orders", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.unique_constraint ["flow_order_id"], name: "payment_orders_flow_order_id_key"
  end
  ...
  create_table "public.persona_inquiries", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.unique_constraint ["persona_inquiry_id"], name: "persona_inquiries_persona_inquiry_id_key"
  end
  ...
  create_table "public.sardine_alerts", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.unique_constraint ["sardine_alert_id"], name: "sardine_alerts_sardine_alert_id_key"
  end
